...
<head>
    <meta charset="utf-8">
    <title>Restoran - <?php echo "Bootstrap Restaurant Template"?></title>
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown"><?php echo "Services"?></h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#"><?php echo "Home"?></a></li>
                            <li class="breadcrumb-item"><a href="#"><?php echo "Pages"?></a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page"><?php echo "Service"?></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="text-center">
                    ...
                    <h1 class="mb-5"><?php echo "Our Clients Say!!!"?></h1>
                </div>
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                        <p><?php echo "Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam"?></p>
                    ...
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                ...
                                <small><?php echo "Profession"?></small>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-item bg-transparent border rounded p-4">
