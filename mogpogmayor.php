    ...
    <section id="testimonials" class="testimonials section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2><?php echo "Leo Livelo"?></h2>
          <p><?php echo "Mayor of Mogpog"?></p>
        </div>
              ...
              <div class="testimonial-item">
                <p>
                  ...
                  <?php echo "Personal Information
                    ...
                    <br>
                    Augusto Leo Livelo is a Filipino politician. He is currently serving as mayor of Mogpog, a municipality of Marinduque Province in MiMaRoPa Region or Region IV-B, Philippines.
                    <br>
                    Augusto Leo Livelo, a candidate for Municipal Mayor in the Philippines' 2022 elections, is running under the Partido Demokratiko Pilipino Lakas ng Bayan. He is hoping to be elected to the seat in Mogpog, Marinduque."?>
                </p>
                <img src=<?php echo "img/mayor23.jpg"?> class="testimonial-img" alt="">
                <h3><?php echo "Leo Livelo"?></h3>
                <h4>Ceo &amp; Founder</h4>
              </div>
