...
<body>
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown"><?php echo "Torrijos Marinduque"?></h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Torrijos is a municipality located in the province of Marinduque, Philippines. Situated on the southeastern part of the island of Marinduque, 
    ...
    <section class="food">
      <h2>Festivals!</h2>
      <p>
        Philippines are not only known by its popular tourist Spots but also in foods.
      </p>

      <div class="row">
        <div class="food-col">
          <img src=<?php echo"img/sinigang.jpg"?> alt="" />
          <h3>Sinigang na Hipon In Luzon</h3>
          <p>
        ...
        <div class="food-col">
          ...
          <h3>Bulalo with Lemongrass and Ginger In Visayas</h3>
          <p>
            The lemongrass lends a subtle citrusy element while the ginger brings forth a zesty kick, 
            making enjoying this fork-tender bulalo an even more reinvigorating experience.
          </p>
        </div>
        <div class="food-col">
          <img src="img/vc.jpeg" alt="" />
          <h3>Curacha In Mindanao</h3>
          <p>
            Curacha is famous in Mindanao, especially in Zamboanga. It’s a spanner crab or red frog
    ...
    <section class="food">
      ...
      <div class="row">
        ...
        <div class="food-col">
          <img src="img/pulang.jpeg" alt="" />
          <h3>Pulang Lupa</h3>
          <p>
          The Battle of Pulang Lupa Marker was built in memory of the Marinduque revolutionary forces that fought the Americans.
        ...
        <div class="food-col">
          <img src="img/bangss.jpg" alt="" />
          <h3>Bangwayin</h3>
          <p>
          Bangwayin is a locality in Marinduque.
    ...
    <section class="food">
      <h2>Best Food that Marinduque can Offer!</h2>
      <p>
        Philippines are not only known by its popular tourist Spots but also in foods.
      </p>
      ...
      <div class="row">
        <div class="food-col">
          ...
          <h3>Suman</h3>
          <p>
          You can find the kakanin suman in many parts of the Philippines.
        ...
        <div class="food-col">
          <img src="img/salab.jpg" alt="" />
          <h3>Sinalab</h3>
          <p>
          SInalab is a native kakanin recipe in Marinduque that is acutely described as a “paper-thin pancake of overripe saba or 
          latundan with flour and buko slices sandwiched between two banana leaves then dry-cooked on a pan.”
          </p>
        </div>
        <div class="food-col">
          <img src="img/miki.jpg" alt="" />
          <h3>Miki</h3>
          <p>
          The province of Marinduque is noted to produce some of the best Miki noodles in the Philippines. 
